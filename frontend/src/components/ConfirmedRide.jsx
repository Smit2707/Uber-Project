    ...
    return (
        <>
            <div className='flex items-center justify-between mb-5'>
                <h3 className='text-xl font-semibold'>Your Ride Details</h3>
                <h5
                    onClick={() => {
            ...
            <div className='flex flex-col gap-2'>
                ...
                <button
                    ...
                    className='w-full flex items-center justify-center gap-3 bg-black rounded font-[400] text-base mt-3 text-white text-center py-1'>Confirm Ride</button>
            </div>
        </>
    )
}
