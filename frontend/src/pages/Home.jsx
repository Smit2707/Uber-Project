...
const Home = () => {
  return (
    <div className='h-screen w-full'>
      <div className='bg-[url("https://images.unsplash.com/photo-1619059558110-c45be64b73ae?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")] bg-cover bg-center h-[80%] w-full'>
        ...
        <h3 className='text-3xl text-white pt-[6%] pl-[6%] font-[500] tracking-wider'>Uber</h3>
      </div>
